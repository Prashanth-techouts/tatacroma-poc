 ...
 */
package de.techouts.pocchroma.storefront.controllers.misc;
...
import de.techouts.pocchroma.storefront.controllers.ControllerConstants;
...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "pocchromastorefront.storefront.minicart.shownProductCount";
	...
	public final String addQuickOrderToCart(@RequestBody final AddToCartOrderForm form, final Model model)
	{
		...
		final int maxQuickOrderEntries = Config.getInt("pocchromastorefront.quick.order.rows.max", 25);
