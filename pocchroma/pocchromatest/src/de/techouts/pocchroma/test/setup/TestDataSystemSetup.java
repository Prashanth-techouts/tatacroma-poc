 ...
 */
package de.techouts.pocchroma.test.setup;
...
import de.techouts.pocchroma.test.constants.PocchromaTestConstants;
import de.techouts.pocchroma.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = PocchromaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/pocchromatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/pocchromatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/pocchromatest/import/cstickets.impex");
			...
			importImpexFile(context, "/pocchromatest/import/csquotes.impex");
		}
	}
}
