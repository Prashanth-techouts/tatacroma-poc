 ...
 */
package de.techouts.pocchroma.fulfilmentprocess.test.jobs;
...
import de.techouts.pocchroma.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = PocchromaFulfilmentProcessConstants.ORDER_PROCESS_NAME;
