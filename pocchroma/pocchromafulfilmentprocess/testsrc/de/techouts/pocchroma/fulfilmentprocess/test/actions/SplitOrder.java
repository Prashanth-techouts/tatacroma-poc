 ...
 */
package de.techouts.pocchroma.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(PocchromaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PocchromaFulfilmentProcessConstants.PARENT_PROCESS);
