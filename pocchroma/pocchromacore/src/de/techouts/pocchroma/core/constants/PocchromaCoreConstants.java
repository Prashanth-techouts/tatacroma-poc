...
/**
 * Global class for all PocchromaCore constants. You can add global constants for your extension into this class.
 */
public final class PocchromaCoreConstants extends GeneratedPocchromaCoreConstants
{
	public static final String EXTENSIONNAME = "pocchromacore";


	private PocchromaCoreConstants()
	{
		//empty
	}
