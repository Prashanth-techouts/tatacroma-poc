 ...
 */
package de.techouts.pocchroma.core.suggestion;
...
import de.techouts.pocchroma.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/pocchromacore/test/testSimpleSuggestionService.csv", "utf-8");
	}
