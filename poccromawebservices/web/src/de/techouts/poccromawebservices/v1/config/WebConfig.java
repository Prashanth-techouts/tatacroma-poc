 ...
 */
package de.techouts.poccromawebservices.v1.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.techouts.poccromawebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "poccromawebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "poccromawebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "poccromawebservices.oauth2.tokenUrl";

	private static final String DESC = "poccromawebservices.v1.description";
	private static final String TITLE = "poccromawebservices.v1.title";
	private static final String VERSION = "poccromawebservices.v1.version";
